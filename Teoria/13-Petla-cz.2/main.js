...
//  const userAge = currentYear - usersDateBirth[i]; //i = iterator używamy za każdym razem żeby  dostać się do tablicy do kazdej wartości. Jeśli wpiszemy jakaś wartośc zamiast i = iteratora, to pętla bedzie nam zwracała ciągle tą wpisaną wartość
// //   console.log(userAge);
